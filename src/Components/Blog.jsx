  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative h-full text-white">
          <h1
            className="text-center text-[clamp(1.5rem,5vw,3rem)] mt-10 text-orange-500 font-bold drop-shadow-xl"
            data-aos="zoom-in"
            data-aos-delay="200"
          >
            🧛‍♂️ Welcome to My Spooky Blog
          </h1>

          <div className="pt-10" data-aos="fade-up" data-aos-delay="400">
            <BlogSwiper />
          </div>
        </div>
      </section>
