...
const Portfolio = () => {
  return (
    <section
      id="projects"
      className="portfolio relative bg-gradient-to-b from-black to-purple-950 pt-30 pb-36 spooky-font text-white overflow-hidden"
      data-aos="fade-up"
    >
      {/* 🎃 Halloween Animated Background Elements */}
      <img
      ...
      <h1
        className="text-center text-[clamp(2rem,5vw,3.5rem)] mb- text-white"
        data-aos="flip-left"
        data-aos-delay="300"
      >
        <span className="animate-pulse">🎃</span> Haunted Web-Projects
      ...
      <div className="w-[70%] md:w-[400px] mx-auto" data-aos="fade-up" data-aos-delay="500">
        <Swiper
          effect="cards"
          grabCursor={true}
          modules={[EffectCards, Autoplay]}
      ...
      <div className="w-[80%] m-auto" data-aos="fade-up" data-aos-delay="600">
        <JavaScriptProject />
      </div>
    </section>
  );
